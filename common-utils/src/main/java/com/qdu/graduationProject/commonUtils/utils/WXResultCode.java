...
public enum WXResultCode {
    ...
    CODE_ERROR(40029,"code 无效"),
    APPID_ERROR(40013,"appid错误"),
    CODE_BLOCKED(40226,"高风险等级用户，小程序登录拦截 。"),
    ...
    PERMISSION_UNAUTHORISED(70002, "权限不足，无权操作！"),
    ...
    public static String getErrorMessage(int errorCode) {
        for (WXResultCode resultCode : WXResultCode.values()) {
            if (resultCode.getCode() == errorCode) {
