...
<form id="formId" class="layui-form layui-form-pane" action="" method="post">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="sectionName" value="" required autocomplete="off" placeholder="请输入板块名称"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">板块信息</label>
        <div class="layui-input-block">
            <input type="text" name="description" value="" required autocomplete="off" placeholder="请输入板块介绍"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
