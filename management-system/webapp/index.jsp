            ...
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;"
                               data-url="<%=request.getContextPath()%>/student?method=selectAll"
                               class="site-demo-active">学生管理</a>
                        </dd>
                        <dd>
                            <a href="javascript:;"
                               data-url="<%=request.getContextPath()%>/teacher?method=selectByPage"
...
<script type="text/javascript">
    ...
    function logout() {
        layer.confirm(
            ...
            {icon: 3},
            function () {
                location.href = '<%=request.getContextPath()%>/adminUser?method=logout'
            }
        );
    }
